...
html_theme_options = {
    ...
    # Persistent GitHub repo link rendered in the sidebar footer (the
    # GitHub mark). `source_repository` only powers the per-page
    # view/edit buttons; this adds an always-visible link to the repo.
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/MengnanLi91/multifid-th",
            "html": (
